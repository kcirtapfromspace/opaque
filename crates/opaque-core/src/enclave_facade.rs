...
//!
//! Profile and task-execution methods live in
//! `opaque_bounded_work::task_facade::BoundedWorkFacade`, alongside the
//! credential-bearing profiles and task ledger types they use. Keeping that
//! extension in bounded work prevents the core crate from depending on those
//! runtime components.
