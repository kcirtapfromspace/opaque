...
fn scrub_paths(text: &str) -> String {
    ...
    let path_re = Regex::new(r"(?:/[Uu]sers/[^\s:]+|/home/[^\s:]+|/tmp/[^\s:]+)")
        .expect("valid regex");
