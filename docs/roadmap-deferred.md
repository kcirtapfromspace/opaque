...
|---------|-------------|--------|--------|
| **MCP server** | Expose Opaque operations as MCP tools for Claude Code | **Shipped** — see [MCP integration](mcp-integration.md) | Large |
| **Bitwarden Secrets Manager** | `bitwarden:` ref scheme, browsing operations, service account auth | **Shipped** — see [Bitwarden](bitwarden.md) | Medium |
